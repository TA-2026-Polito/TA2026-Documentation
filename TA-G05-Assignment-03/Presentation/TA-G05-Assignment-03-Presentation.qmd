...
![Live action](consegna_files/vid/cartwheel_Dario.mp4){width=100%}
:::
::: {.column width="50%"}
...
::: {.column width="50%"}
<!-- SEGNAPOSTO: foto/screenshot della ripresa con cellulare per Live Link -->
![Live action](consegna_files/vid/cartwheel_Fede.mp4){width=100%}
:::
::: {.column width="50%"}
<!-- SEGNAPOSTO: video del dialogo animato sui MetaHuman -->
...
# 1. Totale sulla casa
![](consegna_files/img/inq_totale.png)

# 2. Zenitale sul tavolo
![](consegna_files/img/inq_zenit.png)

# 3. Inquadratura su Dario
![](consegna_files/img/inq_dario.png)

# 4. Inquadratura su Federico
![](consegna_files/img/inq_fede.png)

# 5. Inquadratura su "Gustave"
![](consegna_files/img/inq_gustave.png)
...
![Schema luci](consegna_files/img/light_placement.png){width=100%}
...
![Result](consegna_files/vid/TA-G05-Assignment-03-Cinematic.mp4)
